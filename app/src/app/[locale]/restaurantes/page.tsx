...
export default function RestaurantesPage() {
  ...
  const problems = [
    { icon: Target, title: t('problem1Title'), desc: t('problem1Desc') },
    { icon: BarChart3, title: t('problem2Title'), desc: t('problem2Desc') },
    { icon: Users, title: t('problem3Title'), desc: t('problem3Desc') },
  ]
  ...
  return (
    <div>
      ...
      <div className="bg-amber-50 border-b border-amber-200 px-6 py-3 text-center text-sm text-amber-900">
        {t('founderBanner')}{' '}
        <a href="#fundadores" className="whitespace-nowrap font-semibold underline underline-offset-2 hover:text-amber-700">{tCommon('view')}</a>
      </div>
      ...
      <section className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-gradient-to-b from-stone-800 to-stone-900">
        ...
        <div className="relative mx-auto flex w-full max-w-4xl flex-col items-center gap-8 px-6 py-20 sm:px-8 sm:py-24 lg:gap-10 lg:py-28 xl:px-12">
          ...
          >
          {t('heroTitle')}<br />
          <span className="text-white/90">{t('heroTitleHighlight')}</span>
          </motion.h1>
          ...
          >
            {[t('trust1'), t('trust2'), t('trust3')].map(
              (text) => (
                <span
                  key={text}
          ...
          <ViewportWrapper>
            <div className="mb-14 text-center sm:mb-20">
              ...
              <p className="mx-auto mt-3 max-w-2xl text-stone-500 sm:text-lg">
                {t.rich('founderDesc', { strong: (chunks) => <strong>{chunks}</strong> })}
              </p>
            </div>
          </ViewportWrapper>
          ...
          <div className="mx-auto grid max-w-lg gap-6 sm:grid-cols-2 sm:gap-8 lg:max-w-2xl lg:gap-12">
            ...
            >
              ...
              <div className="space-y-1 p-3 sm:p-4">
                <p className="truncate text-sm font-bold text-stone-400">{t('founderYourRestaurant')}</p>
            ...
            >
              ...
              <div className="space-y-1 p-3 sm:p-4">
                <p className="truncate text-sm font-bold text-stone-900">{t('founderYourRestaurant')}</p>
