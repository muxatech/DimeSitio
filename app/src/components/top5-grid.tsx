      ...
      <div className="space-y-1 p-2.5 sm:p-3">
        ...
        {restaurant.instagram_url && (
          <a
            ...
            className="mt-1.5 inline-flex items-center gap-1 rounded-lg bg-pink-50 px-2 py-1 text-xs font-medium text-pink-700 transition-all hover:bg-pink-100 hover:text-pink-800"
          >
