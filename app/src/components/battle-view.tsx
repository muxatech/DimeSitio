          ...
          {restaurant.instagram_url && (
            <span className="mt-2 block">
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-xl bg-pink-50 px-3 py-1.5 text-sm font-medium text-pink-700 shadow-sm transition-all hover:bg-pink-100 hover:text-pink-800 hover:shadow-md"
              >
